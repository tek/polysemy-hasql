...
--   where
--     target =
--       [exon|select "a", "b", "c", ("sum_field")."ph_sum_index__sum_rec", ("sum_field")."d", ("sum_field")."r"."e", ("sum_field")."r"."f" from "rec" where "a" = $1 and "c" = $2|]
--     Sql stmtText =
...
--   runTestAuto do
--     target === unSql stmtText
--   where
--     target =
--       [exon|insert into "rec" ("a", "b", "c", "sum_field") values ($1, $2, $3, row($4, $5, row($6, $7)))|]
--     stmtText :: Sql
--     stmtText =
...
--   where
--     target =
--       [exon|insert into "rec" ("a", "b", "c", "sum_field") values ($1, $2, $3, row($4, $5, row($6, $7))) on conflict ("a") do update set "a" = $1, "b" = $2, "c" = $3, "sum_field" = row($4, $5, row($6, $7))|]
--     stmtText :: Sql
--     stmtText =
...
--   where
--     target =
--       [exon|create table "rec" ("a" text unique not null, "b" bigint not null, "c" double precision, "sum_field" ph_type__sum_rec not null)|]
--     stmtText :: Sql
--     stmtText =
...
--   where
--     target =
--       [exon|create table "user" ("id" bigint primary key, "name" text not null, "number" double precision not null)|]
--     stmtText :: Sql
--     stmtText =
...
--   where
--     target =
--       [exon|($1 is null or "field2" <= $1) and ($2 is null or "field3" = $2) and "field4" = $3|]
--     target1 =
--       [exon|"field2" <= $1 and ($2 is null or "field3" = $2) and "field4" = $3|]
--     Where qw _ =
...
--   where
--     target =
--       [exon|create table "sum_data" ("ph_sum_index__sum_data" bigint not null, "sum_data1" ph_type__sum_data1 not null, "sum_data2" ph_type__sum_data2 not null)|]
--     Sql stmtText =
...
--   where
--     target =
--       [exon|($1 is null or ("sum")."ph_sum_index__sum_data" = $1) and ($2 is null or ("sum")."sum_data1"."int" = $2) and ($3 is null or ("sum")."sum_data1"."double" = $3) and ($4 is null or ("sum")."sum_data2"."txt" = $4) and ($5 is null or ("sum")."sum_data2"."tixxt" = $5)|]
--     QueryTable _ _ (Where qw _) =
...
--   where
--     target =
--       [exon|"ph_sum_index__sum_data" = $1 and ($2 is null or ("sum_data1")."int" = $2) and ($3 is null or ("sum_data1")."double" = $3) and ($4 is null or ("sum_data2")."txt" = $4) and ($5 is null or ("sum_data2")."tixxt" = $5)|]
--     QueryTable _ _ (Where qw _) =
...
--   where
--     target =
--       [exon|($1 is null or ("sum_data1")."int" = $1) or ($1 is null or ("sum_data2")."int" = $1)|]
--     QueryTable _ _ (Where qw _) =
...
--   where
--     target =
--       [exon|"ph_sum_index__sum_una" = $1 and ($2 is null or "una_l" = $2) and ($3 is null or "una_r" = $3)|]
--     QueryTable _ _ (Where qw _) =
...
--   where
--     target =
--       [exon|"ph_sum_index__sum_una_ext" = $1 and ($2 is null or ("sum_una_ext_l")."una_l" = $2) and ($3 is null or "una_r" = $3)|]
--     QueryTable _ _ (Where qw _) =
...
--   where
--     target =
--       [exon|create table "idq_test" ("payload" ph_type__idq_test not null)|]
--     Sql stmtText =
...
--   where
--     target =
--       [exon|($1 is null or ("una_sum1")."double" = $1) or ($1 is null or ("una_sum2")."double" = $1)|]
--     QueryTable _ _ (Where qw _) =
